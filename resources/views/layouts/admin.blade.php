...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="flex flex-col md:flex-row min-h-screen" x-data="{open:true}" x-show="open">
  ...
  <div class="flex flex-1 justify-end">
    <button @click="open= flase" type="button" class="-m-3 p-3 focus-visible:-outline-offset-4">
...
<div class="flex-1 p-4 bg-slate-50 overflow-auto">
           {{$slot}}
        </div>
    </div>
    </body>
