  ...
  <div class="max-w-7xl mx-auto bg-white shadow rounded-lg p-6">
    <div class="flex items-center justify-between mb-4">
      <div>
        ...
        <p class="text-sm text-gray-500">A list of all the permissions in your account including their name, title, email and role.</p>
      </div>
      <button class="bg-indigo-600 text-white px-4 py-2 rounded-md shadow hover:bg-indigo-700 text-sm"><a href="{{route('admin.permissions.create')}}">Create Permission</a></button>
    </div>
