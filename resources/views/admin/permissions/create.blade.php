<x-admin-layout>
  ...
  <div class="max-w-7xl mx-auto bg-white shadow rounded-lg p-6">
    <div class="flex items-center justify-between mb-4">
      ...
      <button class="bg-indigo-600 text-white px-4 py-2 rounded-md shadow hover:bg-indigo-700 text-sm"><a href="{{route('admin.permissions.index')}}">Permission Index Page</a></button>
    </div>
